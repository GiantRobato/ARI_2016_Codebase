...
unsigned int encoding_table[4096], decoding_table[2048];
unsigned int data, codeword, recd;
unsigned int position[23] = { 0x00000001, 0x00000002, 0x00000004, 0x00000008,
                      0x00000010, 0x00000020, 0x00000040, 0x00000080,
                      0x00000100, 0x00000200, 0x00000400, 0x00000800,
                      0x00001000, 0x00002000, 0x00004000, 0x00008000,
                      0x00010000, 0x00020000, 0x00040000, 0x00080000,
                      0x00100000, 0x00200000, 0x00400000 };
unsigned int numerr, errpos[23], decerror = 0;
int a[4];

unsigned int arr2int(int* a,int r)
/*
 * Convert a binary vector of Hamming weight r, and nonzero positions in
 * array a[1]...a[r], to a unsigned int integer \sum_{i=1}^r 2^{a[i]-1}.
 */
{
   int i;
   unsigned int mul, result = 0, temp;
...
unsigned int get_syndrome(unsigned int pattern)
/*
...
unsigned int encode_golay(unsigned int data)
{
/*
...
unsigned int decode_golay(unsigned int codeword)
{
/*
...
main()
{
  unsigned int data,encoded,decoded;
  data = 0x0b;
  printf("data: %x \n",data);
